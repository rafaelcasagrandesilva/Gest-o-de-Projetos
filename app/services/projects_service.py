...
class ProjectsService:
    ...
    async def create_project(self, *, actor_user_id, data: dict) -> Project:
        proj = Project(**data)
    ...
    async def update_project(self, *, actor_user_id, project_id, data: dict) -> Project:
    ...
    async def delete_project(self, *, actor_user_id, project_id) -> None:
        proj = await self.get_project(project_id)
        before = model_to_dict(proj)
