...
async def get_project_labor_details(
    ...
    return await _svc(db).list_labor_details(project_id=project_id, competencia=competencia)
...
async def list_structure_labors(
    ...
    return await _svc(db).list_labors_read(project_id=project_id, competencia=competencia)
...
async def create_structure_labor(
    ...
    return await _svc(db).create_labor(project_id=project_id, data=payload.model_dump())
...
async def list_structure_vehicles(
    ...
    return await _svc(db).list_project_vehicles_read(project_id=project_id, competencia=competencia)
...
async def create_structure_vehicle(
    ...
    return await _svc(db).create_project_vehicle(project_id=project_id, data=payload.model_dump())
...
async def list_structure_systems(
    ...
    rows = await _svc(db).list_systems(project_id=project_id, competencia=competencia)
...
async def create_structure_system(
    ...
    row = await _svc(db).create_system(project_id=project_id, data=payload.model_dump())
...
async def list_structure_fixed(
    ...
    rows = await _svc(db).list_fixed(project_id=project_id, competencia=competencia)
...
async def create_structure_fixed(
    ...
    row = await _svc(db).create_fixed(project_id=project_id, data=payload.model_dump())
